...
*** Test Cases ***
FT-14 Modify only remark in the transaction and save
    ...
    Transaction::Input Remark    This is an art
    ...
    Should Contain Any     ${actualTransactionInfo}    expenditure    Taipei    This is an art
