...
*** Test Cases ***
FT-65 Generate the report with location and period
    Go To Report Page
    Click Element After It Is Visible    //*[@resource-id="android:id/list"]//*[@text="以地點 / 期間統計"]
    ...
    Wait Until Element Is Visible On Page    //*[@resource-id="ru.orangesoftware.financisto:id/report_filter_name" and @text="Taipei"]
    ...
    Click Element After It Is Visible    //*[@resource-id="ru.orangesoftware.financisto:id/bt_filter_next"]
    Wait Until Element Is Visible On Page    //*[@resource-id="ru.orangesoftware.financisto:id/report_filter_name" and @text="Taiwan"]
