...
...                    AND    Create A New Transaction    AccountForTest    accepter    james    play    1000    Taiwan    suite    saProject
...
*** Test Cases ***
FT-58 Generate the report with classification
    Go To Report Page
    Click Element After It Is Visible    //*[@resource-id="android:id/list"]//*[@text="依分類"]
