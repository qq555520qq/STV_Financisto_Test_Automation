...
*** Test Cases ***
FT-63 Generate the report with classification and period
    Go To Report Page
    Click Element After It Is Visible    //*[@resource-id="android:id/list"]//*[@text="以分類 / 期間統計"]
    ...
    Wait Until Element Is Visible On Page    //*[@resource-id="ru.orangesoftware.financisto:id/report_filter_name" and @text="expenditure"]
    ...
    Click Element After It Is Visible    //*[@resource-id="ru.orangesoftware.financisto:id/bt_filter_next"]
    Wait Until Element Is Visible On Page    //*[@resource-id="ru.orangesoftware.financisto:id/report_filter_name" and @text="play"]
