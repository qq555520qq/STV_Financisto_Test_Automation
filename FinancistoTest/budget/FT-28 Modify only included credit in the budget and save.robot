...
*** Test Cases ***
FT-28 Modify only included credit in the budget and save
    Long Press    //*[@resource-id="android:id/list"]/android.widget.RelativeLayout[1]
    Click Element After It Is Visible    //*[@text="編輯"]
    Click Element After It Is Visible    //*[@resource-id="ru.orangesoftware.financisto:id/include_credit"]/android.widget.CheckBox[1]
