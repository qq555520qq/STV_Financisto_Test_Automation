...
Test Teardown    Run Keywords    Delete Budget    reviseBudget
...
*** Test Cases ***
FT-22 Modify only budget name in the budget and save
    Long Press    //*[@resource-id="android:id/list"]/android.widget.RelativeLayout[1]
    Click Element After It Is Visible    //*[@text="編輯"]
    Clear Text After It Is Visible    //*[@resource-id="ru.orangesoftware.financisto:id/list"]/android.widget.LinearLayout[1]/android.widget.RelativeLayout[1]/android.widget.EditText[1]
    Budget::Input Name    reviseBudget
    Common::Click Ok Button
    ${actualBudgetName} =    Get Text After It Is Visible    //*[@resource-id="ru.orangesoftware.financisto:id/center"]
    Should Be Equal    ${actualBudgetName}    reviseBudget