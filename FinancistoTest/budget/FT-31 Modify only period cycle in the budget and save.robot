...
*** Test Cases ***
FT-31 Modify only period cycle in the budget and save
    Long Press    //*[@resource-id="android:id/list"]/android.widget.RelativeLayout[1]
    Click Element After It Is Visible    //*[@text="編輯"]
    Click Element After It Is Visible    //*[@resource-id="ru.orangesoftware.financisto:id/period_recur"]/android.widget.RelativeLayout[1]
    Click Element After It Is Visible    //*[@resource-id="ru.orangesoftware.financisto:id/intervalSpinner"]
    Click Element After It Is Visible    //*[@text='每月']
